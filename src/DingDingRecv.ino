...
#define ESPNOW_PREFIX "DingDing:"

// Commands: ? will answer via ESPNOW-Broadcast, rest will just copied to Serial1
// DingDing:qwertzuiop Tones a-h-c-d-e-f-g-h-a-c
...
void loop() {
  ...
  if(doAnswer) {
    doAnswer = false;
    sprintf(msg,"DongDong V1.0, Uptime: %lu", millis());
